<?php
/**
* designingreen functions and definitions
...
function designingreen_scripts() {

    // load Bootstrap CSS v5.1
    wp_enqueue_style( 'designingreen-bootstrap-css', THEME_DIR_URI . '/includes/css/bootstrap.min.css');

    // load website CSS, versioned
    wp_enqueue_style( 'designingreen-css', THEME_DIR_URI . '/assets/css/style.css', [], filemtime( get_stylesheet_directory() . '/assets/css/style.css') );

	// load Bootstrap JS v5.1
	wp_enqueue_script( 'designingreen-bootstrap-js', THEME_DIR_URI . '/includes/js/bootstrap.min.js', array('jquery') );
}
add_action( 'wp_enqueue_scripts', 'designingreen_scripts' );
...
/* Register menus */
if ( ! function_exists( 'designingreen_setup' ) ) :
	function designingreen_setup() {

    register_nav_menus( array(
        'primary' => __( 'Primary Menu', 'designingreen' ),
        'footer'  => __( 'Footer Menu', 'designingreen' ),
    ) );
...
add_action( 'after_setup_theme', 'designingreen_setup');
